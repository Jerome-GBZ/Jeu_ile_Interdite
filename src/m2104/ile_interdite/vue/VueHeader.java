...
public class VueHeader {
    ...
    public VueHeader(ArrayList<Aventurier> listA){
        ...
        if(listA.size() == 2){
            ...
            Image imgPerso1;
            imgPerso1 = Toolkit.getDefaultToolkit().getImage("Images/personnages/" + listA.get(0).getRole() + ".png").getScaledInstance(85, 116, 85);
            
            Image imgPerso2;
            imgPerso2 = Toolkit.getDefaultToolkit().getImage("Images/personnages/" + listA.get(0).getRole() + ".png").getScaledInstance(85, 116, 85);
            ...
            panelButton.setOpaque(false);
            b3.add(panelButton);
            JLabel nom3 = new JLabel(listA.get(0).getNom() , SwingConstants.RIGHT);
                    nom3.setForeground(Color.WHITE);
                    nom3.setSize(200, 200);

                    panelButton.add(nom3,BorderLayout.SOUTH);
            ...
            Image imgPerso3;
            imgPerso3 = Toolkit.getDefaultToolkit().getImage("Images/personnages/" + listA.get(0).getRole() + ".png").getScaledInstance(85, 116, 85);
            ...
            panelButton.setOpaque(false);
            b2.add(panelButton);
            JLabel nom2 = new JLabel(listA.get(0).getNom() , SwingConstants.RIGHT);
            ...
            Image imgPerso4;
            imgPerso4 = Toolkit.getDefaultToolkit().getImage("Images/personnages/" + listA.get(0).getRole() + ".png").getScaledInstance(85, 116, 85);
            ...
            panelButton.setOpaque(false);
            b4.add(panelButton);
            JLabel nom4 = new JLabel(listA.get(0).getNom() , SwingConstants.RIGHT);
